    ...
    <div className="flex items-center container-div flex-col mt-20 md:mt-40 justify-center px-4">
      ...
      <div className="w-full max-w-md bg-gray-100 p-8 rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSignIn}>
          ...
          <button 
            type="submit" 
            className="w-full h-10 flex items-center justify-center bg-black text-white py-3 rounded-xl font-medium hover:opacity-90 transition"
          >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl py-3 bg-white hover:bg-gray-50 transition"
        >
          {gLoading ? <Spinner />:<><FcGoogle size={24} />
